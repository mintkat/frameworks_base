...
public class TelecomManager {
    ...
    */
    ...
    /**
     * The following 3 constants define how the incoming call should be handled by the Telecomm
     * server when there is already an active call.
     */

    /**
     * Indicates that Telecomm server should show a pop up to ask user whether to end or hold the
     * current active call when another incoming call is detected
     * @hide
     */
    public static final int CALL_WAITING_RESPONSE_SHOW_POPUP = 1;
     ...
     * @hide
     */
    public static final int CALL_WAITING_RESPONSE_NO_POPUP_END_CALL = 2;
     ...
     * @hide
     */
    public static final int CALL_WAITING_RESPONSE_NO_POPUP_HOLD_CALL = 3;
