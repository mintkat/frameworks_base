...
public final class PhoneStatusBarTransitions extends BarTransitions {
    ...
    private View mLeftSide, mStatusIcons, mSignalCluster, mBattery, mClock, mCenterClock,
                   mNetworkTraffic, mLeftClock, mMinitBattery, mBrLogo;
    ...
    public void init() {
        ...
        mBrLogo = mView.findViewById(R.id.br_logo);
    ...
    private void applyMode(int mode, boolean animate) {
        ...
        if (animate) {
            ...
            anims.playTogether(
                    ...
                    animateTransitionTo(mBrLogo, newAlphaBC)
                    );
            if (isLightsOut(mode)) {
